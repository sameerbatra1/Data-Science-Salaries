...
rf_pred <- rf_pred * (salary_max - salary_min) + salary_min
```
...
```{r}
rmse_val <- RMSE(rf_pred, test_df$salary_scaled)
r2_val <- R2(rf_pred, test_df$salary_scaled)
mae_val <- MAE(rf_pred, test_df$salary_scaled)
